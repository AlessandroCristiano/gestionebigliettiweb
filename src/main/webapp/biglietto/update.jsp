							...
							<form method="post" action="ExecuteUpdateBigliettoServlet" class="row g-3" novalidate="novalidate">
								...
								<div class="col-md-6">
									...
									<input type="text" name="provenienza" id="provenienza" class="form-control" placeholder="Inserire la provenienza"  
										value="${bigliettoDaInviareAPaginaUpdate.provenienza}" required>
								</div>
								...
								<div class="col-md-6">
									...
									<input type="text" name="destinazione" id="destinazione" class="form-control" placeholder="Inserire la destinazione"  
										value="${bigliettoDaInviareAPaginaUpdate.destinazione}" required>
								</div>
								...
								<div class="col-md-3">
									...
									<input class="form-control"  name="data" id="data" type="date" placeholder="dd/MM/yy" title="formato : gg/mm/aaaa" 
										value="<fmt:formatDate pattern="yyyy-MM-dd" value="${bigliettoDaInviareAPaginaUpdate.data}"/>" required/>
								</div>
								
								<div class="col-md-6">
									<label for="prezzo" class="form-label">Prezzo <span class="text-danger">*</span></label>
									<input type="number" class="form-control" name="prezzo" id="prezzo" placeholder="Inserire prezzo" 
									value="${bigliettoDaInviareAPaginaUpdate.prezzo}" required>
								</div>
								
								
							<div class="col-12">
								<button type="submit" name="submit" value="submit" id="submit" class="btn" style="background-color: #00cc00;">Conferma</button>
								<input type="hidden" name="idBiglietto" value="${bigliettoDaInviareAPaginaUpdate.id}">
							</div>
